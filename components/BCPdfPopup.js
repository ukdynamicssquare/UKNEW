...
const BcPopPdf = ({ pdfType }) => {
  ...
  function handleCloseModal() {
    document.getElementById("pdfModel").classList.remove("show", "d-block");
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      setSubmitting(true);
      try {
        await emailjs.sendForm('service_bwardy4', 'template_e13glbp', e.target, 'JMglIoOzliJzdMCd4');
