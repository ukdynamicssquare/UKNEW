        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 mobile-1 align-self-center">
              <h1>Dynamics 365 Business Central for Distribution</h1>
              <p>Ensure timely delivery, get real-time inventory tracking, perform demand forecasting, and manage complete warehouse operations with Dynamics 365 Business Central.</p>
              <div>
