        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 mobile-4 align-self-center">
              ...
              <div>
                <div className="text-center text-lg-start">
                  ...
                  >
                    <span>Schedule Free Health Care</span></a>
                  </Link>
                </div>
              </div>
            </div>
            <div className="col-lg-6 align-self-center">
              <Image
                src="/img/Dynamics-365-for-Healthcare.png"
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <div className="call-to-action-content">
                <h3>Dynamics 365 for Healthcare accelerator</h3>
                <p>
                  Identify your current system performance and upgrading needs
                  with Dynamics 365 for Healthcare.
                </p>
                <div className="text-center m-o-t new-btn-nn">
                  <Link href="#exampleModal">
                    ...
                    className="btn-get-started scrollto"
                  >
                    <span>Book a Free Healthcare</span></a>
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="style-grid-1">
                <div className="style-grid-content">
                  <h3>Improve Patient Engagement</h3>
                  <p>Dynamics 365 provides great capabilities for all businesses, resulting in personalised and engaging patient experiences. Also, it let the users communicate with the staff in real-time whenever needed, resulting in instant issue resolution, whether it was about financial details or doctor availability. </p>
                </div>
              </div>

              <div className="style-grid-1">
                <div className="style-grid-content">
                  <h3>Get patient insights </h3>
                  <p>With the cloud deployment, you can easily collaborate, share, and track the required data in real-time. Even so, it offers true insights about patients so that management can make favourable decisions whenever desired, resulting in enhanced healthcare efficiencies. </p>
                </div>
              </div>
              <div className="style-grid-1">
                <div className="style-grid-content">
                  <h3>Encourage clinical staff collaboration</h3>
                  <p>It enables the healthcare industry to fetch and utilise the data to offer flexible treatment plans. Clinical staff can establish communication with another member to collaborate and offer better services. </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="style-grid-1">
                <div className="style-grid-content">
                  <h3>Examine Previous Records </h3>
                  <p>The patient's previous records contain the essential data and disease history. It helps the doctors understand the previous medical conditions so that they can give the patient a better and more sustainable treatment. </p>
                </div>
              </div>
              ...
              <div className="style-grid-1">
                <div className="style-grid-content">
                  ...
                  <p>Microsoft Dynamics 365 for healthcare offers automation to eliminate most of the manual and recurring tasks from the system. It automatically fetches the data and forwards it to the next step without concerning anyone, resulting in enhanced productivity for the clinical staff.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="commen-rit-info text-center">
                <h3>Conclusion</h3>
                <p>As per the market reports, implementing Dynamics 365 in the healthcare industry has enhanced operational efficiency by 40%, resulting in a 25% increase in ROI. No doubt, it is a powerful solution that helps healthcare organisations improve patient care, streamline operations, and drive business growth. Its ability to integrate with other native and third-party systems, like EHRs (electronic health records), is remarkable. This allows healthcare providers to access patient information in real-time, reducing the risk of errors and improving patient care. It also includes a range of security and compliance features for the protection of patient data. </p>
                <p>Overall, Microsoft Dynamics 365 for healthcare is an excellent solution for such organisations that are looking to improve the patient journey, simplify existing operations, and accelerate business growth.</p>
                <p>Perhaps it is time to implement Dynamics 365 for Healthcare in your organisation because you, too, want to simplify operations, increase revenue, and focus more on growing the business rather than resolving day-to-day issues. For <Link href="https://blog.dynamicssquare.co.uk/dynamics-365-pricing-and-licensing/"><a>Dynamics 365 pricing</a></Link> and Microsoft cloud for healthcare licensing, contact Dynamic Square, the UK's <Link href="/"><a>Microsoft Certified Gold Partner</a></Link>. You can send us an email at <b>info@dynamicssquare.co.uk</b> or call us at 0207-193-2502 to get immediate answers to all of your questions.</p>
              </div>
            </div>
          </div>
        </div>
