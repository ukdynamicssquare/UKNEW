                ...
                <div className="new-contant-head">
                  ...
                  <div className="new-flex-wraper">
                    ...
                    <div className="new-flex-se">
                      ...
                      <div className="right">
                        <span>Successful Implementation</span>
                        <p>350+ projects implemented and counting!</p>
                      </div>
                    </div>
                    <div className="new-flex-se">
                      <div className="left">
                      ...
                      <div className="right">
                        ...
                        <p>Take your business to the next level with the unwavering support of our certified professionals.</p>
                      </div>
                    </div>
                    <div className="new-flex-se">
                      <div className="left">
                      ...
                      <div className="right">
                        ...
                        <p>Quick turnaround time to fuel your business growth.</p>
                      </div>
                    </div>
                    <div className="new-flex-se">
                      <div className="left">
                      ...
                      <div className="right">
                        ...
                        <p>Your success is our success! As your partner in growth, we’re committed to offering constant support for your business.</p>
                      </div>
                    </div>
                  </div>
                </div>
