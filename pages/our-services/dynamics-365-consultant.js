...
const Dynamics365Consultant = () => {
  return (
    <>
      <Head>
        <title>
        Microsoft Dynamics 365 Consultant UK | Dynamics Square
        </title>
        <meta
          name="description"
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-6">
                <Image src="/img/Microsoft-Dynamics-365-consulting.png" alt="Microsoft-Dynamics-365-consulting" width={708} height={525}  priority = {true} />
              </div>
            </div>
          </div>
        </section>
              ...
              <div className="col-lg-7 align-self-center">
                <div className="domain-expertise-left domain-expertise-left-1">
                  <div className="title-header">
                    <h3>150+ Microsoft Dynamics 365 Consultants Available at your Fingertips </h3>
                  </div>
        ...
        <section className="why-slider">
          <div className="container">
            <header className="section-header">
              <h2>Why Choose Dynamics Square for your Business? </h2>
              <p>Dynamics Square is the leading Microsoft Solution Partner offering its services to businesses in the UK and Europe. We have separate experienced consultants available to deal with various issues of different industries. Our experts include technical consultants, functional consultants, ERP/CRM architects, and business analysts to streamline your business irrespective of complexity.  </p>
              <p>We have consultants who not only deal with Microsoft Dynamics 365 business application issues but also offer their services for <Link href="/products/microsoft-power-platform/"><a>Microsoft Power Platform</a></Link>. With sufficient resources and a good number of CRM/ERP consultants, we are readily available to boost your business while simplifying the existing resources.  </p>
              <p><b>We can Help you with:</b> </p>
            </header>
            <div className="row g-5" style={{paddingTop:'40px'}}>
            <div className="col-lg-6">
        ...
        <section className="call_to_action call_to_action-height">
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-7 align-self-center">
                <div className="call_to_action-left" style={{marginTop:'-30px'}}>
                  <h3>Want to achieve great heights of your business while optimizing the processes? </h3>
                  <p>Sel Dynamics 365 consultants can take your business to the next level (of growth and success).</p>
            ...
            <div className="row">
              <div className="code-list">
                <ul>
                  ...
                  <li>24*7/365<span>Unmatchable <br /> Support </span></li>
                </ul>
              </div>
            </div>
            <div className="row g-5" style={{paddingTop:'40px'}}>
