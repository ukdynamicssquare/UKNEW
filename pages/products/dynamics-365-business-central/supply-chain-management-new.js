          ...
          <div className="row" style={{ paddingBottom: '20px' }}>
            <div className="col-lg-8">
              <div className="supprt-header-new-one">
                ...
                <p>D365 Business Central for supply chain creates a chain where each link strengthens the next. From planning to fulfilment, the platform ensures that no weak spots remain hidden.</p>
          ...
          <div className="row" style={{ paddingBottom: '20px' }}>
            <div className="col-lg-8">
              <div className="supprt-header-new-one">
                ...
                <p>It often happens when decisions are urgent and reports are too slow. Copilot inside Business Central supports action. It analyses data and provides insights without requiring a data science team.</p>
                <p><b>Key aspects:</b></p>
              </div>
            </div>
          </div>
