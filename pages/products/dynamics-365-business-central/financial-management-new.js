          ...
          <div className='row'>
            <div className='col-lg-7'>
              <div className="solution-new-banner-sub-head">
                ...
                <p>Business Central is the next step when you outgrow your accounting software. It is a complete Microsoft ERP built to bring every financial touchpoint together and breathe intelligence into your processes.</p>
