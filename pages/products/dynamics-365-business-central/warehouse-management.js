            ...
            <div className='col-lg-7'>
              ...
              <div className='row' style={{ paddingBottom: '20px' }}>
                <div className="col-lg-12">
                  <p style={{ marginBottom: '30px' }}><b>Core impact areas:</b></p>
                </div>
          ...
          <div className="row" style={{ paddingBottom: '30px' }}>
            <div className="col-lg-8">
              <div className="supprt-header-new-one">
                ...
                <p><a href="/wms-for-business-central/">WMS in Business Central</a> is a zero-compromise system. If your business ships more than a hundred orders a day, you need more than a spreadsheet. You need process automation, audit trails, data integrity, and most importantly, task accountability.</p>
              ...
              <div className='row'>
                <div className="col-lg-12">
                  <div className="solution-new-banner-sub-head">
                    ...
                    <p>Warehouse transformations only work if the implementation is surgical. That’s where Dynamics Square plays a vital role. With years of experience in <a href="/dynamics-365-business-central-implementation/">Business Central implementation</a>, Dynamics Square ensures:</p>
                  </div>
                </div>
                <div className='col-lg-6 d-flex '>
                  <div className='card557'>
