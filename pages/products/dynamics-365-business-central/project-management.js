          ...
          <div className='row justify-content-center'>
            <div className='col-lg-8'>
              ...
              <div className='m-b-image-banner'>
                <Image src="/img/bc-project-banner.png" alt='bc-project-banner' width={970} height={641} />
                <div className='ff-one'>  <span className=''>Job Costing &amp; Budgeting</span></div>
                <div className='ff-two'>  <span className=''>Resource Management</span></div>
              </div>
            </div>
          ...
          <div className='row'>
            <div className='col-lg-7'>
              <div className="solution-new-banner-sub-head">
                ...
                <p>Project management in <a href="/products/dynamics-365-business-central/">Dynamics 365 Business Central</a> is the backbone of intelligent delivery for growing service-driven companies. From scoping to billing, it offers connected tools to control budgets, allocate resources, track progress, and stay audit-ready.</p>
            ...
            <div className='col-lg-5 align-self-center'>
              <div className='img-backs-sid'>
                <Image src="/img/bc-project-side-01.png" alt="bc-project-side-01" width={318} height={436} className='im-two' />
              </div>
            </div>
          </div>
        </div>
                ...
                <div className='mycard'>
                  <div className='mycard__inner'>
                    ...
                    <div className='mycard__inner-right'>
                      <Image src="/img/bc-project-side-02.png" width={581} height={456} alt="Card 3" />
                    </div>
                  </div>
                </div>
                <div className='mycard'>
                  <div className='mycard__inner'>
                    ...
                    <div className='mycard__inner-right'>
                      <Image src="/img/bc-project-side-03.png" width={581} height={456} alt="Card 3" />
                    </div>
                  </div>
                </div>
                <div className='mycard'>
                  <div className='mycard__inner'>
                    ...
                    <div className='mycard__inner-right'>
                      <Image src="/img/bc-project-side-04.png" width={581} height={456} alt="Card 3" />
                    </div>
                  </div>
                </div>
                <div className='mycard'>
                  <div className='mycard__inner'>
                    ...
                    <div className='mycard__inner-right'>
                      <Image src="/img/bc-project-side-05.png" width={581} height={456} alt="Card 3" />
                    </div>
                  </div>
                </div>
                <div className='mycard'>
                  <div className='mycard__inner'>
                    ...
                    <div className='mycard__inner-right'>
                      <Image src="/img/bc-project-side-06.png" width={581} height={456} alt="Card 3" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="row g-3">
            <div className="col-lg-4">
              <div className='support-image--onea'>
                <Image src="/img/bc-project-side-07.png" alt='warehouse-management-side-01' width={318} height={436} />
              </div>
            </div>
