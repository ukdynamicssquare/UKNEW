          ...
          <div className='row g-3 m-t-4'>
            ...
            <div className='col-lg-4'>
              <div className='solution-new-six-card-cat'>
                <h3>Simplify Compliance and Reporting</h3><br />
                <p style={{ margin: '-13px 0px 0px', fontSize: '14px' }}>Generate accurate reports, automate tax processes, and keep pace with changing regulations confidently.</p>
                <Link href="#exampleModal"><a
                  data-bs-toggle="modal"
                  className="btn-get-started scrollto"
                >
