                ...
                >
                  <div className="row">
                    <div className="col-lg-6">
                      ...
                      <a href="https://www.youtube.com/watch?v=pzA1OdN79nI" target="_blank" className="over-ff">
                          <img
                    ...
                    <div className="col-lg-6">
                      <div className="card card-custom-1">
                      <a href="https://youtu.be/AzXqHqEoocY" target="_blank" className="over-ff">
                          <img
                            className="card-img-top"
                    ...
                    <div className="col-lg-6">
                      <div className="card card-custom-1">
                      <a href="https://www.youtube.com/watch?v=Evkj4zfpk0Q" target="_blank" className="over-ff">
                          <img
                            className="card-img-top"
                    ...
                    <div className="col-lg-6">
                      <div className="card card-custom-1">
                      <a href="https://www.youtube.com/watch?v=OI4H1Lxxk9E" target="_blank" className="over-ff">
                          <img
                            className="card-img-top"
                    ...
                    <div className="col-lg-6">
                      <div className="card card-custom-1">
                      <a href="https://www.youtube.com/watch?v=4sdOb8PUE-o" target="_blank" className="over-ff">
                          <img
                            className="card-img-top"
