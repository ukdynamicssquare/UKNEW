...
const PowerBiSupportSolutions = () => {
  ...
  return (
    <>
      <Head>
        <title>Microsoft Power BI Support Service with Dynamics Square UK - Case Study</title>
        <meta
          name="description"
          content="We resolved data inefficiency issue to get real-time data from different sources. The UK's company is very happy with their Power BI support solutions."
        />
        <link
          rel="canonical"
          href="https://www.dynamicssquare.co.uk/case-studies/power-bi-support-solutions/"
        />
      </Head>
            ...
            <div className="col-lg-6 align-self-center">
              <div className="webin-top-left case-study-bann">
                <div className="top-se">
                  ...
                  <h1>Microsoft Power BI Support </h1>
                  <p>Resolved data inefficiency issue to get real-time data from different sources. </p>
                </div>
              </div>
            </div>
            <div className="col-lg-6 align-self-center">
              ...
              <div className="content-icons-modil-1">
                <div className="content-inner-moil-1">
                  ...
                  <div className="cintent-right">
                    <p>Auto refresh of data analysis was not working. </p>
                  </div>
                </div>
                ...
                <div className="content-inner-moil-1">
                  ...
                  <div className="cintent-right">
                    <p>Facing difficulties in collecting data from a source. </p>
                  </div>
                </div>
                ...
                <div className="content-inner-moil-1">
                  ...
                  <div className="cintent-right">
                    <p>Dealing issues with the data retrieval process. </p>
                  </div>
                </div>
                <div className="content-inner-moil-1">
                  <div className="icons-left">
                  ...
                  <div className="cintent-right">
                    <p>Monitoring the health of reports and dashboards. </p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="industry-more-sec casestudy-list-more">
        <div className="container">
          <header className="section-header">
            ...
            <p>Offered our cost-effective and reliable Microsoft Power BI support.</p>
          </header>
                      ...
                      <div className="swiper-slide">
                        <div className="industries-list-more">
                          ...
                          <div className="text-wrp-content">
                            <p>Performed permission setup for the service account.</p>
                          </div>
                        </div>
                      </div>
                    </SwiperSlide>
                      ...
                      <div className="swiper-slide">
                        <div className="swiper-slide">
                          <div className="industries-list-more">
                            ...
                            <div className="text-wrp-content">
                              <p>Activated Auto Refresh to empower them with real-time reporting.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="swiper-slide">
                        <div className="swiper-slide">
                          <div className="industries-list-more">
                            ...
                            <div className="text-wrp-content">
                              <p>Access query folding and query reduction to optimise data retrieval. </p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="swiper-slide">
                        <div className="swiper-slide">
                          <div className="industries-list-more">
                            ...
                            <div className="text-wrp-content">
                              <p>Monitor reports and dashboard health using automated data refresh schedules. </p>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div className="col-lg-6 align-self-center">
              <div className="content-icons-modil-1">
                <div className="content-inner-moil-1">
                  ...
                  <div className="cintent-right">
                    <p>They can now build reports and analyse the data with ease. </p>
                  </div>
                </div>
                ...
                <div className="content-inner-moil-1">
                  ...
                  <div className="cintent-right">
                    <p>Access charts, graphs, tables, and maps to convey information effectively. </p>
                  </div>
                </div>
                <div className="content-inner-moil-1">
                  <div className="icons-left">
                  ...
                  <div className="cintent-right">
                    <p>Monitor and make quick decisions based on real-time data. </p>
                  </div>
                </div>
                <div className="content-inner-moil-1">
                  <div className="icons-left">
                  ...
                  <div className="cintent-right">
                    <p>Keep an eye on reporting performance and usage. </p>
                  </div>
                </div>
              </div>
            </div>
...
export default PowerBiSupportSolutions;
