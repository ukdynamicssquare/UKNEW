...
const MicrosoftPowerBiImplementation = () => {
  ...
  return (
    <>
      <Head>
        <title>Case Study: Microsoft Power BI Implementation</title>
        <meta
          name="description"
          content="Check the Microsoft Power BI Implementation Case Study:  We simplified sales and stock analysis with real-time reporting."
        />
        <link
          rel="canonical"
            ...
            <div className="col-lg-6 align-self-center">
              <div className="webin-top-left case-study-bann">
                <div className="top-se">
                  ...
                  <h1>Microsoft Power BI Implementation </h1>
                  <p>Simplified sales and stock analysis with real-time reporting.</p>
                </div>
              </div>
            </div>
            <div className="col-lg-6 align-self-center">
              ...
              <div className="content-icons-modil-1">
                <div className="content-inner-moil-1">
                  ...
                  <div className="cintent-right">
                    <p>The business was lacking in getting real-time reports and performing data analysis to achieve sustainable growth. </p>
                  </div>
                </div>
                ...
                <div className="content-inner-moil-1">
                  ...
                  <div className="cintent-right">
                    <p>They were looking for an additional solution that could help them build sales and stock analysis reports. </p>
                  </div>
                </div>
                ...
                <div className="content-inner-moil-1">
                  ...
                  <div className="cintent-right">
                    <p>The business wants to utilise the data to make actionable and data-driven decisions for stocks and sales processes. </p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="industry-more-sec casestudy-list-more">
        <div className="container">
          <header className="section-header">
            ...
            <p>Integrated Microsoft Power BI with Business Central.</p>
          </header>
                      ...
                      <div className="swiper-slide">
                        <div className="industries-list-more">
                          ...
                          <div className="text-wrp-content">
                            <p>The business is now able to access real-time reports of sales, stocks, and business insights. </p>
                          </div>
                        </div>
                      </div>
                    </SwiperSlide>
                      ...
                      <div className="swiper-slide">
                        <div className="swiper-slide">
                          <div className="industries-list-more">
                            ...
                            <div className="text-wrp-content">
                              <p>With the standard implementation of Power BI, we have developed two additional reports: the Sales Analysis Report and the Stock Analysis Report. </p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="swiper-slide">
                        <div className="swiper-slide">
                          <div className="industries-list-more">
                            ...
                            <div className="text-wrp-content">
                              <p>The business is now able to analyse entire stocks and sales data from single dashboards. </p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="swiper-slide">
                        <div className="swiper-slide">
                          <div className="industries-list-more">
                            ...
                            <div className="text-wrp-content">
                              <p>Such sales reports would empower the client to focus on enhancing the customer experience and offering them the right product at the right time. </p>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div className="col-lg-6">
              <div className="content-icons-modil-1">
                <div className="content-inner-moil-1">
                  ...
                  <div className="cintent-right">
                    <p>The business is now able to analyse sales reports using different parameters, which include total sales by product, customer, region, and time period. </p>
                  </div>
                </div>
                ...
                <div className="content-inner-moil-1">
                  ...
                  <div className="cintent-right">
                    <p>The team can now find the most popular and least popular products while getting profitable product categories. </p>
                  </div>
                </div>
                <div className="content-inner-moil-1">
                  <div className="icons-left">
                  ...
                  <div className="cintent-right">
                    <p>They can now analyse stocks using different parameters, like total inventory levels by product, location, and time period. </p>
                  </div>
                </div>
                <div className="content-inner-moil-1">
                  <div className="icons-left">
                  ...
                  <div className="cintent-right">
                    <p>Also, the business can now find products with low stock levels and high stock levels. </p>
                  </div>
                </div>
              </div>
            </div>
...
export default MicrosoftPowerBiImplementation;
